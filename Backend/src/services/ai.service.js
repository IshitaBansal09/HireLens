...
async function generateResumePdf({resume, selfDescription, jobDescription}){
    ...
    const prompt = `Generate a resume in HTML format for a candidate based on the following information:
                        ...
                        The resume should be tailored for the given job description and should highlight the candidate's strength, relevant skills and experience. The resume should be in a professional format and should be easy to read. The HTML content should be well formatted and should be responsive. The resume should be in a single page format. The resume should be in a clean and modern design.
                        the content of resume should not sound like its generated by ai, and be as close to human writing style as possible. The resume should be in a professional tone and should not contain any spelling or grammatical errors.
                        ...
                        The resume should not be so lengthy, should ideally be 1-2 pages long when converted to PDF. Focus on quality rather than qualtity and make sure to include all the relevant information that can increase the candidate's chances of getting an interview call for the given job description.
                    `
